                    ...
                    <div class="cc-inside">
                        <div class="columns">
                            ...
                            <div class="cc-w-auto cc-right">
                                <router-link class="btn cc-bg-blue fa-plus" :to="{name:'user-add'}">Add a user</router-link>
                            </div>
                            <div class="cc-w-auto cc-right">
                        ...
                        <table class="cc-equal-cols cc-hovered">
                            <thead>
                                <tr>
                                    ...
                                    <th @click="sortBy('datas.mycompany')" :class="[{ active: sortKey == 'datas.mycompany' },sortType[0], 'sort']">
                                        Company
                                    </th>
                                    <th @click="sortBy('datas.role')" :class="[{ active: sortKey == 'datas.role' },sortType[0], 'sort']">
                                        Role
                                    </th>
                                    <th>
                                        Action
                            ...
                            <tbody>
                                <tr v-for="(data, index) in datasShown">
                                    ...
                                    <td>
                                        <router-link class="btn cc-thin cc-bg-primary fa-edit" :to="{name:'user-profile', params:{id: data._id}}">View</router-link>
...
<script>
    ...
    import { findAllUsers, DeleteUser } from '../../../services/user.service'
