                        ...
                        <table class="cc-equal-cols cc-hovered">
                            ...
                            <tbody>
                                <tr v-for="(data, index) in datasShown">
                                    <td>
                                        {{ data.lastname | upper}} {{ data.firstname| capitalize }}
                                    </td>
                                    <td v-if="data.plannings">
                                        {{data.plannings[new Date().getMonth()+" "+new Date().getFullYear()][0]}}
                                        <br />
                                        {{data.plannings[new Date().getMonth()+" "+new Date().getFullYear()][1]}}
                                    </td>
                                    <td v-else>
                                    </td>
                                    <td class="data-date">
                                    ...
                                    <td>
                                        <router-link class="btn cc-thin cc-bg-primary fa-edit" :to="{name:'monthly-planning-add', params:{id: data.id}}">Add Planning</router-link>
                                        <router-link class="btn cc-thin cc-bg-primary fa-edit" :to="{name:'monthly-planning-all', params:{id: data.id}}">View Older Plannings</router-link>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
