            ...
            <div v-if="!fetchError">
                ...
                <div class="cc-inside">
                        ...
                        <table class="cc-equal-cols cc-hovered">
                            ...
                            <tbody>
                                <tr v-for="(data, index) in datasShown">
                                    ...
                                    <td>
                                        <router-link class="btn cc-thin cc-bg-primary fa-edit" :to="{name:'leaving-register', params:{id: data.id}}">Leaving</router-link>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="cc-w-auto cc-right">
                        <router-link class="btn cc-bg-green fa-plus" :to="{name:'employee-register'}">Add register</router-link>
                    </div>
        ...
        methods: {
            ...
            searchInTable() {
                ...
                let filtered_datas = _.filter(that.datas, function (p) {
                    return _.includes(p.position.toLowerCase(), that.searchQuery.toLowerCase()) || _.includes(p.firstname.toLowerCase(), that.searchQuery.toLowerCase()) || _.includes(p.lastname.toLowerCase, that.searchQuery.toLowerCase())
                })
